...
%prep
%setup -q -n arandr-0.1.11
cd %{_builddir}/arandr-0.1.11
pushd ..
cp -a arandr-0.1.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676566128
...
cp %{_builddir}/arandr-%{version}/COPYING %{buildroot}/usr/share/package-licenses/arandr/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
